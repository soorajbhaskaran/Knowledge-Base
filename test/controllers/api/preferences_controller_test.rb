...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_should_show_the_proper_preference
    get api_preference_path, headers: @headers
  ...
  def test_should_update_preference
    patch api_preference_path, params: { preference: { name: "Updated", password: "welcome12345" } }, headers: @headers
    assert_response :success
    assert_equal "Updated", @preference.reload.name
  end

  def test_users_must_be_able_authenticate_with_valid_preference_password
    put api_preference_path, params: { preference: { password: "welcome12345" } }, headers: @headers
    assert_response :success
